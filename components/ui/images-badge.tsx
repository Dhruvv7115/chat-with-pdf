      ...
      >
        ...
        {displayImages.map((image, index) => {
          ...
          return (
            <motion.div
              key={index}
              className="absolute top-0.5 left-1/2 origin-bottom overflow-hidden rounded-[4px] bg-white shadow-sm ring-1 shadow-black/10 ring-black/10 dark:bg-neutral-900 dark:shadow-white/10 dark:ring-white/10"
              animate={{
            ...
            >
              {typeof image === "string" ? (
                ...
                <div className="h-full w-full select-none flex items-center justify-center overflow-hidden">
                  {image}
                </div>
              )}
            </motion.div>
