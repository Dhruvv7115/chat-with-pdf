  ...
  return (
    <div className={cn("relative", className)}>
      <button
        ...
        className="group relative cursor-pointer border-0 bg-transparent p-0 block w-full"
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full block rounded-2xl border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
