...
export const useNavbarVisible = () => useContext(NavbarVisibilityContext);
...
export const NavbarLogo = () => {
	return (
		...
		>
			<div className="flex size-8 items-center justify-center rounded-md bg-primary/90 text-white dark:text-slate-700">
...
export const NavbarButton = ({
	...
	const variantStyles = {
		primary:
			"shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] bg-lime-600 hover:bg-lime-700 dark:bg-lime-700 dark:hover:bg-lime-600 text-white transition-colors ",
