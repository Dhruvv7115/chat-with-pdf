...
export function FeaturesSection() {
	return (
		<section
			id="features"
			className="relative w-full overflow-hidden border-t bg-background text-accent-foreground [--pattern-fg:var(--color-black)]/10 dark:bg-background dark:[--pattern-fg:var(--color-white)]/10 flex flex-col items-center justify-center px-3 md:px-10"
		>
			<div className="border-x mx-5 md:mx-10 relative pt-16">
				...
				<div className="relative mt-16">
					<div className="mx-auto max-w-7xl">
						<div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden divide-x divide-y divide-border border-t border-border">
