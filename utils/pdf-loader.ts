...
import { MAX_PDF_CHARS } from "@/constants/chat";
...
export async function indexDocument(
	...
	try {
		...
		console.error("Indexing failed, cleaning up partial state:", error);

		// Remove any partial embeddings so retrieval never sees an incomplete doc
		await client.documentEmbedding.deleteMany({ where: { documentId: docId } });
